...
def main():
	print('\nWelcome to Pentago! The first player to get 5 marbles in a row wins the game. In each turn,',
		...
		'(int 1...4) and the direction of rotation ("R" or "L"). See the following diagrams for reference.',
		'Good luck!',
		'\n\nBoard Layout:\n5 \n4 \n3 \n2 \n1 \n0 \n 0 1 2 3 4 5 \n\nSquare Index Layout:\n2   4\n1   3\n')
	new_game()
...
def new_game():
	...
	if final_score == -.5:
		print("Both players have 5 in a row, its a tie!")
	if final_score == -.6:
