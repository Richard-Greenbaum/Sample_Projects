(* Need a more interesting way of representing CNN's *)
open Matrix
let height = Matrix.height
let width = Matrix.width

(* Need a slide setting *)

(* A filter setting *)

(** [unwrap x] unwraps an option into its value *)
(* WILL REIMPLEMENT MATRIX.ML AS A MONAD *)
let unwrap = function
